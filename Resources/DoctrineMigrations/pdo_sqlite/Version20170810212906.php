...
class Version20170810212906 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__revision AS SELECT id, content_type_id, created, modified, auto_save_at, deleted, version, ouuid, start_time, end_time, draft, lock_by, auto_save_by, lock_until, labelField, finalized_by, raw_data, auto_save, circles, sha1 FROM revision');
        ...
        $this->addSql('INSERT INTO revision (id, content_type_id, created, modified, auto_save_at, deleted, version, ouuid, start_time, end_time, draft, lock_by, auto_save_by, lock_until, labelField, finalized_by, raw_data, auto_save, circles, sha1) SELECT id, content_type_id, created, modified, auto_save_at, deleted, version, ouuid, start_time, end_time, draft, lock_by, auto_save_by, lock_until, labelField, finalized_by, raw_data, auto_save, circles, sha1 FROM __temp__revision');
