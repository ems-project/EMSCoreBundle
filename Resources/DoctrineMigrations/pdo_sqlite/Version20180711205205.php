...
final class Version20180711205205 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__analyzer AS SELECT id, name, dirty, label, created, modified, order_key, options FROM analyzer');
        $this->addSql('DROP TABLE analyzer');
        $this->addSql('CREATE TABLE analyzer (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, dirty BOOLEAN NOT NULL, label VARCHAR(255) NOT NULL COLLATE BINARY, created DATETIME NOT NULL, modified DATETIME NOT NULL, order_key INTEGER DEFAULT NULL, options CLOB NOT NULL --(DC2Type:json_array)
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO analyzer (id, name, dirty, label, created, modified, order_key, options) SELECT id, name, dirty, label, created, modified, order_key, options FROM __temp__analyzer');
        ...
        $this->addSql('INSERT INTO content_type (id, field_types_id, environment_id, created, modified, name, pluralName, singularName, icon, description, indexTwig, extra, lockBy, lockUntil, circles_field, deleted, have_pipelines, ask_for_ouuid, dirty, color, labelField, color_field, parentField, userField, dateField, startDateField, endDateField, locationField, referer_field_name, category_field, ouuidField, imageField, videoField, email_field, asset_field, order_field, sort_by, create_role, edit_role, view_role, orderKey, rootContentType, edit_twig_with_wysiwyg, active, publish_role, trash_role, sort_order, web_content, default_value) SELECT id, field_types_id, environment_id, created, modified, name, pluralName, singularName, icon, description, indexTwig, extra, lockBy, lockUntil, circles_field, deleted, have_pipelines, ask_for_ouuid, dirty, color, labelField, color_field, parentField, userField, dateField, startDateField, endDateField, locationField, referer_field_name, category_field, ouuidField, imageField, videoField, email_field, asset_field, order_field, sort_by, create_role, edit_role, view_role, orderKey, rootContentType, edit_twig_with_wysiwyg, active, publish_role, trash_role, sort_order, web_content, default_value FROM __temp__content_type');
        ...
        , PRIMARY KEY(id), CONSTRAINT FK_6D6315CC1A445520 FOREIGN KEY (content_type_id) REFERENCES content_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__filter AS SELECT id, name, dirty, label, created, modified, order_key, options FROM filter');
        $this->addSql('DROP TABLE filter');
        $this->addSql('CREATE TABLE filter (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, dirty BOOLEAN NOT NULL, label VARCHAR(255) NOT NULL COLLATE BINARY, created DATETIME NOT NULL, modified DATETIME NOT NULL, order_key INTEGER DEFAULT NULL, options CLOB NOT NULL --(DC2Type:json_array)
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, name, dirty, label, created, modified, order_key, options) SELECT id, name, dirty, label, created, modified, order_key, options FROM __temp__filter');
        ...
        $this->addSql('CREATE TABLE job (id INTEGER NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, output CLOB DEFAULT NULL COLLATE BINARY, done BOOLEAN NOT NULL, started BOOLEAN NOT NULL, progress INTEGER NOT NULL, username VARCHAR(255) DEFAULT NULL COLLATE BINARY, service VARCHAR(255) DEFAULT NULL COLLATE BINARY, command VARCHAR(255) DEFAULT NULL COLLATE BINARY, status CLOB DEFAULT NULL, arguments CLOB DEFAULT NULL --(DC2Type:json_array)
        , PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE i18n (id INTEGER NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, identifier VARCHAR(200) NOT NULL COLLATE BINARY, content CLOB NOT NULL --(DC2Type:json_array)
        , PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "view" (id INTEGER NOT NULL, content_type_id BIGINT DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, type VARCHAR(255) NOT NULL COLLATE BINARY, icon VARCHAR(255) DEFAULT NULL COLLATE BINARY, orderKey INTEGER NOT NULL, options CLOB DEFAULT NULL --(DC2Type:json_array)
        ...
        $this->addSql('INSERT INTO template (id, content_type_id, created, modified, name, icon, body, header, edit_with_wysiwyg, render_option, orderKey, accumulate_in_one_file, preview, mime_type, filename, extension, active, role, role_to, role_cc, response_template, email_content_type, circles_to, orientation, size) SELECT id, content_type_id, created, modified, name, icon, body, header, edit_with_wysiwyg, render_option, orderKey, accumulate_in_one_file, preview, mime_type, filename, extension, active, role, role_to, role_cc, response_template, email_content_type, circles_to, orientation, size FROM __temp__template');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__search AS SELECT id, username, contentTypes, name, sort_by, sort_order, default_search, environments FROM search');
        $this->addSql('DROP TABLE search');
        $this->addSql('CREATE TABLE search (id INTEGER NOT NULL, username VARCHAR(100) NOT NULL COLLATE BINARY, contentTypes CLOB NOT NULL --(DC2Type:json_array)
        , name VARCHAR(100) NOT NULL COLLATE BINARY, sort_by VARCHAR(100) DEFAULT NULL COLLATE BINARY, sort_order VARCHAR(100) DEFAULT NULL COLLATE BINARY, default_search BOOLEAN DEFAULT \'0\' NOT NULL, environments CLOB NOT NULL --(DC2Type:json_array)
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO search (id, username, contentTypes, name, sort_by, sort_order, default_search, environments) SELECT id, username, contentTypes, name, sort_by, sort_order, default_search, environments FROM __temp__search');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE analyzer');
        $this->addSql('CREATE TABLE analyzer (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, dirty BOOLEAN NOT NULL, label VARCHAR(255) NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, order_key INTEGER DEFAULT NULL, options CLOB NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        ...
        $this->addSql('DROP TABLE filter');
        $this->addSql('CREATE TABLE filter (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, dirty BOOLEAN NOT NULL, label VARCHAR(255) NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, order_key INTEGER DEFAULT NULL, options CLOB NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        ...
        $this->addSql('DROP TABLE job');
        $this->addSql('CREATE TABLE job (id INTEGER NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, output CLOB DEFAULT NULL, done BOOLEAN NOT NULL, started BOOLEAN NOT NULL, progress INTEGER NOT NULL, username VARCHAR(255) DEFAULT NULL, service VARCHAR(255) DEFAULT NULL, command VARCHAR(255) DEFAULT NULL, status VARCHAR(2048) NOT NULL COLLATE BINARY, arguments CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        ...
        $this->addSql('DROP TABLE revision');
        $this->addSql('CREATE TABLE revision (id INTEGER NOT NULL, content_type_id BIGINT DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, auto_save_at DATETIME DEFAULT NULL, deleted BOOLEAN NOT NULL, version INTEGER DEFAULT 1 NOT NULL, start_time DATETIME NOT NULL, end_time DATETIME DEFAULT NULL, draft BOOLEAN NOT NULL, finalized_by VARCHAR(255) DEFAULT NULL, deleted_by VARCHAR(255) DEFAULT NULL, lock_by VARCHAR(255) DEFAULT NULL, auto_save_by VARCHAR(255) DEFAULT NULL, lock_until DATETIME DEFAULT NULL, labelField CLOB DEFAULT NULL, sha1 VARCHAR(255) DEFAULT NULL, ouuid VARCHAR(255) DEFAULT NULL COLLATE BINARY, raw_data CLOB DEFAULT NULL COLLATE BINARY, auto_save CLOB DEFAULT NULL COLLATE BINARY, circles CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_6D6315CC1A445520 ON revision (content_type_id)');
        $this->addSql('CREATE UNIQUE INDEX tuple_index ON revision (end_time, ouuid)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__search AS SELECT id, username, environments, contentTypes, name, default_search, sort_by, sort_order FROM search');
        $this->addSql('DROP TABLE search');
        $this->addSql('CREATE TABLE search (id INTEGER NOT NULL, username VARCHAR(100) NOT NULL, contentTypes CLOB NOT NULL COLLATE BINARY, name VARCHAR(100) NOT NULL, default_search BOOLEAN DEFAULT \'0\' NOT NULL, sort_by VARCHAR(100) DEFAULT NULL, sort_order VARCHAR(100) DEFAULT NULL, environments CLOB NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO search (id, username, environments, contentTypes, name, default_search, sort_by, sort_order) SELECT id, username, environments, contentTypes, name, default_search, sort_by, sort_order FROM __temp__search');
        $this->addSql('DROP TABLE __temp__search');
        $this->addSql('DROP INDEX IDX_A6263002650760A9');
        $this->addSql('CREATE TEMPORARY TABLE __temp__search_filter AS SELECT id, search_id, pattern, field, boolean_clause, operator, boost FROM search_filter');
        $this->addSql('DROP TABLE search_filter');
