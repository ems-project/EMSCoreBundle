 ...
 */
final class Version20180808055434 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO template (id, content_type_id, created, modified, name, icon, body, header, edit_with_wysiwyg, render_option, orderKey, accumulate_in_one_file, preview, mime_type, filename, extension, active, role, role_to, role_cc, response_template, email_content_type, orientation, size, circles_to) SELECT id, content_type_id, created, modified, name, icon, body, header, edit_with_wysiwyg, render_option, orderKey, accumulate_in_one_file, preview, mime_type, filename, extension, active, role, role_to, role_cc, response_template, email_content_type, orientation, size, circles_to FROM __temp__template');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE search');
        $this->addSql('CREATE TABLE search (id INTEGER NOT NULL, username VARCHAR(100) NOT NULL, environments CLOB NOT NULL --(DC2Type:json_array)
        ...
        $this->addSql('DROP TABLE "view"');
        $this->addSql('CREATE TABLE "view" (id INTEGER NOT NULL, content_type_id BIGINT DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, icon VARCHAR(255) DEFAULT NULL, orderKey INTEGER NOT NULL, options CLOB DEFAULT \'NULL --(DC2Type:json_array)\' COLLATE BINARY --(DC2Type:json_array)
        , PRIMARY KEY(id))');
