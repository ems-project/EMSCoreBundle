 ...
 */
final class Version20180916121314 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__revision AS SELECT id, content_type_id, created, modified, auto_save_at, deleted, version, start_time, end_time, draft, lock_by, auto_save_by, lock_until, labelField, finalized_by, sha1, deleted_by, ouuid, raw_data, auto_save, circles, finalized_date FROM revision');
        ...
        $this->addSql('INSERT INTO revision (id, content_type_id, created, modified, auto_save_at, deleted, version, start_time, end_time, draft, lock_by, auto_save_by, lock_until, labelField, finalized_by, sha1, deleted_by, ouuid, raw_data, auto_save, circles, finalized_date) SELECT id, content_type_id, created, modified, auto_save_at, deleted, version, start_time, end_time, draft, lock_by, auto_save_by, lock_until, labelField, finalized_by, sha1, deleted_by, ouuid, raw_data, auto_save, circles, finalized_date FROM __temp__revision');
        ...
        , allow_origin VARCHAR(255) DEFAULT NULL, disposition VARCHAR(20) DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_97601F831A445520 FOREIGN KEY (content_type_id) REFERENCES content_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
