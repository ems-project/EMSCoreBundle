 ...
 */
final class Version20190204202605 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE asset_storage ADD COLUMN confirmed BOOLEAN DEFAULT \'0\' NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__asset_storage AS SELECT id, created, modified, hash, context, contents, last_update_date, size FROM asset_storage');
        ...
        $this->addSql('INSERT INTO asset_storage (id, created, modified, hash, context, contents, last_update_date, size) SELECT id, created, modified, hash, context, contents, last_update_date, size FROM __temp__asset_storage');
