...
final class Version20200713151817 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__environment AS SELECT id, created, modified, name, alias, color, baseUrl, managed, in_default_search, extra, order_key, circles, snapshot FROM environment');
        ...
        $this->addSql('INSERT INTO environment (id, created, modified, name, alias, color, baseUrl, managed, in_default_search, extra, order_key, circles, snapshot) SELECT id, created, modified, name, alias, color, baseUrl, managed, in_default_search, extra, order_key, circles, snapshot FROM __temp__environment');
