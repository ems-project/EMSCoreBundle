 ...
 */
final class Version20200722150146 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE form_verification (id CHAR(36) NOT NULL --(DC2Type:uuid)
        , value VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, created DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , expiration_date DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , PRIMARY KEY(id))');
        ...
        , ouuid VARCHAR(255) DEFAULT NULL COLLATE utf8_bin, CONSTRAINT FK_6D6315CC1A445520 FOREIGN KEY (content_type_id) REFERENCES content_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__environment AS SELECT id, created, modified, name, alias, color, baseUrl, managed, in_default_search, extra, order_key, snapshot, circles FROM environment');
        $this->addSql('DROP TABLE environment');
        $this->addSql('CREATE TABLE environment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, alias VARCHAR(255) NOT NULL COLLATE BINARY, color VARCHAR(50) DEFAULT NULL COLLATE BINARY, baseUrl VARCHAR(1024) DEFAULT NULL COLLATE BINARY, managed BOOLEAN NOT NULL, in_default_search BOOLEAN DEFAULT NULL, extra CLOB DEFAULT NULL COLLATE BINARY, order_key INTEGER DEFAULT NULL, snapshot BOOLEAN DEFAULT \'0\' NOT NULL, circles CLOB DEFAULT NULL --(DC2Type:json_array)
        )');
        $this->addSql('INSERT INTO environment (id, created, modified, name, alias, color, baseUrl, managed, in_default_search, extra, order_key, snapshot, circles) SELECT id, created, modified, name, alias, color, baseUrl, managed, in_default_search, extra, order_key, snapshot, circles FROM __temp__environment');
        ...
        $this->addSql('CREATE TABLE cache_asset_extractor (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, hash VARCHAR(255) NOT NULL COLLATE BINARY, data CLOB DEFAULT NULL --(DC2Type:json_array)
        )');
        ...
        $this->addSql('CREATE TABLE asset_storage (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, contents BLOB NOT NULL, size BIGINT NOT NULL, confirmed BOOLEAN DEFAULT \'0\' NOT NULL, hash VARCHAR(128) NOT NULL, context VARCHAR(128) DEFAULT NULL, last_update_date INTEGER NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE asset_storage');
        $this->addSql('CREATE TABLE asset_storage (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, contents BLOB NOT NULL, size BIGINT NOT NULL, confirmed BOOLEAN DEFAULT \'0\' NOT NULL, hash VARCHAR(1024) NOT NULL COLLATE BINARY)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__cache_asset_extractor AS SELECT id, created, modified, hash, data FROM cache_asset_extractor');
        $this->addSql('DROP TABLE cache_asset_extractor');
        $this->addSql('CREATE TABLE cache_asset_extractor (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, hash VARCHAR(255) NOT NULL, data CLOB DEFAULT \'NULL --(DC2Type:json_array)\' COLLATE BINARY --(DC2Type:json_array)
        )');
        $this->addSql('INSERT INTO cache_asset_extractor (id, created, modified, hash, data) SELECT id, created, modified, hash, data FROM __temp__cache_asset_extractor');
        $this->addSql('DROP TABLE __temp__cache_asset_extractor');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_83D3C2A4D1B862B8 ON cache_asset_extractor (hash)');
