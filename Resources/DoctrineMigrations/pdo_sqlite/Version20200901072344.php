 ...
 */
final class Version20200901072344 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__form_submission AS SELECT id, created, modified, name, instance, locale, data, process_id, process_try_counter FROM form_submission');
        ...
        , created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, instance VARCHAR(255) NOT NULL COLLATE BINARY, locale VARCHAR(2) NOT NULL COLLATE BINARY, process_id VARCHAR(255) DEFAULT NULL COLLATE BINARY, process_try_counter INTEGER DEFAULT 0 NOT NULL, data CLOB DEFAULT NULL --(DC2Type:json_array)
        , process_by VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO form_submission (id, created, modified, name, instance, locale, data, process_id, process_try_counter) SELECT id, created, modified, name, instance, locale, data, process_id, process_try_counter FROM __temp__form_submission');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL, instance VARCHAR(255) NOT NULL, locale VARCHAR(2) NOT NULL, process_try_counter INTEGER DEFAULT 0 NOT NULL, process_id VARCHAR(255) DEFAULT NULL, data CLOB NOT NULL COLLATE BINARY --(DC2Type:json_array)
        , PRIMARY KEY(id))');
