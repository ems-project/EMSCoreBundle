...
class ContentTypeService
{
    ...
    public function deleteFields(ContentType $contentType): void
    {
        $em = $this->doctrine->getManager();
    ...
    public function deleteTemplates(ContentType $contentType): void
    {
        $em = $this->doctrine->getManager();
    ...
    public function deleteViews(ContentType $contentType): void
    {
        $em = $this->doctrine->getManager();
