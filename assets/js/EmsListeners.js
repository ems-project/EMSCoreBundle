...
export default class EmsListeners {
    ...
    addDisabledButtonTreatListeners() {
        let form = document.querySelector('form[name="treat_notifications"]');

        jquery('#treat_notifications_publishTo').on('change', function () {
            let isDisabledAccept = this.value.length === 0;
