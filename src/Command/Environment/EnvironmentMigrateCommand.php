...
final class EnvironmentMigrateCommand extends AbstractCommand
{
    ...
    {
        $arguments = [RevisionArchiveCommand::ARGUMENT_CONTENT_TYPE => $this->contentTypeTo->getName()];
        $options = [
            RevisionArchiveCommand::OPTION_FORCE => true,
            RevisionArchiveCommand::OPTION_MODIFIED_BEFORE => $archiveModifiedBefore->format(\DateTimeInterface::ATOM),
        ];
