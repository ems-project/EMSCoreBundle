...
class ReleaseOverviewDataTableType extends AbstractEntityTableType
{
    ...
    public function build(EntityTable $table): void
    {
        ...
        $table->addColumnDefinition(new TemplateBlockTableColumn(t('field.docs_count', [], 'emsco-core'), 'docs_count', \sprintf('@%s/release/columns/revisions.html.twig', $this->templateNamespace)))->setCellClass('text-right');
        ...
        $table->addItemGetAction(
            ...
            labelKey: t('action.set_status_ready', [], 'emsco-core'),
            icon: 'play',
        ...
        $table->addItemGetAction(
            route: Routes::RELEASE_SET_STATUS,
            labelKey: t('action.set_status_wip', [], 'emsco-core'),
            icon: 'rotate-left',
        ...
        $table->addItemPostAction(
            ...
            labelKey: t('action.publish_release', [], 'emsco-core'),
            icon: 'toggle-on',
        ...
        $table->addItemGetAction(
            route: Routes::RELEASE_SET_STATUS,
            labelKey: t('action.set_status_canceled', [], 'emsco-core'),
            icon: 'ban',
        ...
        $table->addItemPostAction(
            ...
            icon: 'trash',
            messageKey: t('message.release_delete_confirm', [], 'emsco-core'),
        ...
        $table->addTableAction(
            ...
            confirmationKey: t('message.release_delete_selected_confirm', [], 'emsco-core')
