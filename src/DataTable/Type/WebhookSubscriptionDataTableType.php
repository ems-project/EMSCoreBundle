...
class WebhookSubscriptionDataTableType extends AbstractEntityTableType
{
    ...
    public function build(EntityTable $table): void
    {
        ...
        $table->addItemPostAction(Routes::WEBHOOK_SUBSCRIPTION_TOGGLE_ENABLE, t('action.enable', [], 'emsco-core'), 'check-square-o', t('action.confirmation', [], 'emsco-core'));
        $table->addItemPostAction(Routes::WEBHOOK_SUBSCRIPTION_TEST, t('action.test', [], 'emsco-core'), 'check', t('action.confirmation', [], 'emsco-core'));
