...
final class Version20221023190143 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE content_type DROP userField, DROP dateField, DROP startDateField, DROP endDateField, DROP locationField, DROP ouuidField, DROP videoField, DROP email_field');
