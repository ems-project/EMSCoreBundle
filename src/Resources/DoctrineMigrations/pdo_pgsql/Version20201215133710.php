...
final class Version20201215133710 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE channel (id UUID NOT NULL, created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, modified TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, name VARCHAR(255) NOT NULL, public BOOLEAN DEFAULT \'false\' NOT NULL, slug VARCHAR(255) NOT NULL, options JSON DEFAULT NULL, PRIMARY KEY(id))');
