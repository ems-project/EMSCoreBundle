 ...
 */
final class Version20210729112026 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE task (id UUID NOT NULL, title VARCHAR(255) NOT NULL, deadline TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, assignee TEXT NOT NULL, description TEXT NOT NULL, logs JSON NOT NULL, PRIMARY KEY(id))');
