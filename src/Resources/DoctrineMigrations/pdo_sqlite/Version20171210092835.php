 ...
 */
class Version20171210092835 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE analyzer (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, dirty BOOLEAN NOT NULL, label VARCHAR(255) NOT NULL COLLATE BINARY, created DATETIME NOT NULL, modified DATETIME NOT NULL, options CLOB NOT NULL, order_key INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE filter (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, dirty BOOLEAN NOT NULL, label VARCHAR(255) NOT NULL COLLATE BINARY, created DATETIME NOT NULL, modified DATETIME NOT NULL, options CLOB NOT NULL, order_key INTEGER DEFAULT NULL, PRIMARY KEY(id))');
