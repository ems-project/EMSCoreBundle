 ...
 */
class Version20180131093007 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE managed_alias (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, alias VARCHAR(255) NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, color VARCHAR(50) DEFAULT NULL, extra CLOB DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__environment AS SELECT id, created, modified, name, alias, color, baseUrl, managed, in_default_search, extra, circles, order_key FROM environment');
        $this->addSql('DROP TABLE environment');
        $this->addSql('CREATE TABLE environment (id INTEGER NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, alias VARCHAR(255) NOT NULL COLLATE BINARY, color VARCHAR(50) DEFAULT NULL COLLATE BINARY, baseUrl VARCHAR(1024) DEFAULT NULL COLLATE BINARY, managed BOOLEAN NOT NULL, in_default_search BOOLEAN DEFAULT NULL, extra CLOB DEFAULT NULL COLLATE BINARY, order_key INTEGER DEFAULT NULL, circles CLOB DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO environment (id, created, modified, name, alias, color, baseUrl, managed, in_default_search, extra, circles, order_key) SELECT id, created, modified, name, alias, color, baseUrl, managed, in_default_search, extra, circles, order_key FROM __temp__environment');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__analyzer AS SELECT id, name, dirty, label, created, modified, options, order_key FROM analyzer');
        $this->addSql('DROP TABLE analyzer');
        $this->addSql('CREATE TABLE analyzer (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, dirty BOOLEAN NOT NULL, label VARCHAR(255) NOT NULL COLLATE BINARY, created DATETIME NOT NULL, modified DATETIME NOT NULL, order_key INTEGER DEFAULT NULL, options CLOB NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO analyzer (id, name, dirty, label, created, modified, options, order_key) SELECT id, name, dirty, label, created, modified, options, order_key FROM __temp__analyzer');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__filter AS SELECT id, name, dirty, label, created, modified, options, order_key FROM filter');
        $this->addSql('DROP TABLE filter');
        $this->addSql('CREATE TABLE filter (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, dirty BOOLEAN NOT NULL, label VARCHAR(255) NOT NULL COLLATE BINARY, created DATETIME NOT NULL, modified DATETIME NOT NULL, order_key INTEGER DEFAULT NULL, options CLOB NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, name, dirty, label, created, modified, options, order_key) SELECT id, name, dirty, label, created, modified, options, order_key FROM __temp__filter');
        ...
        $this->addSql('CREATE TABLE uploaded_asset (id INTEGER NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, status VARCHAR(64) DEFAULT NULL COLLATE BINARY, sha1 VARCHAR(40) NOT NULL COLLATE BINARY, name VARCHAR(1024) NOT NULL COLLATE BINARY, type VARCHAR(1024) NOT NULL COLLATE BINARY, username VARCHAR(255) NOT NULL COLLATE BINARY, available BOOLEAN NOT NULL, size BIGINT NOT NULL, uploaded BIGINT NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE revision');
        $this->addSql('CREATE TABLE revision (id INTEGER NOT NULL, content_type_id BIGINT DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, auto_save_at DATETIME DEFAULT NULL, deleted BOOLEAN NOT NULL, version INTEGER DEFAULT 1 NOT NULL, start_time DATETIME NOT NULL, end_time DATETIME DEFAULT NULL, draft BOOLEAN NOT NULL, finalized_by VARCHAR(255) DEFAULT NULL, deleted_by VARCHAR(255) DEFAULT NULL, lock_by VARCHAR(255) DEFAULT NULL, auto_save_by VARCHAR(255) DEFAULT NULL, lock_until DATETIME DEFAULT NULL, labelField VARCHAR(255) DEFAULT NULL COLLATE BINARY, sha1 VARCHAR(255) DEFAULT NULL, ouuid VARCHAR(255) DEFAULT NULL COLLATE BINARY, raw_data CLOB DEFAULT NULL COLLATE BINARY, auto_save CLOB DEFAULT NULL COLLATE BINARY, circles CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
