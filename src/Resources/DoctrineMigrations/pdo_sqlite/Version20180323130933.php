...
class Version20180323130933 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE sequence (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, value INTEGER NOT NULL, version INTEGER DEFAULT 1 NOT NULL, PRIMARY KEY(id))');
