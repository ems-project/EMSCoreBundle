 ...
 */
class Version20180416081913 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__search AS SELECT id, username, contentTypes, name, sort_by, sort_order, environments, default_search FROM search');
        ...
        $this->addSql('INSERT INTO search (id, username, contentTypes, name, sort_by, sort_order, environments, default_search) SELECT id, username, contentTypes, name, sort_by, sort_order, environments, default_search FROM __temp__search');
