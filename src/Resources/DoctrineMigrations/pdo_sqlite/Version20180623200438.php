 ...
 */
class Version20180623200438 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE template (id INTEGER NOT NULL, content_type_id BIGINT DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, icon VARCHAR(255) DEFAULT NULL COLLATE BINARY, body CLOB DEFAULT NULL COLLATE BINARY, header CLOB DEFAULT NULL COLLATE BINARY, edit_with_wysiwyg BOOLEAN NOT NULL, render_option VARCHAR(255) NOT NULL COLLATE BINARY, orderKey INTEGER NOT NULL, accumulate_in_one_file BOOLEAN NOT NULL, preview BOOLEAN NOT NULL, mime_type VARCHAR(255) DEFAULT NULL COLLATE BINARY, filename CLOB DEFAULT NULL COLLATE BINARY, extension VARCHAR(255) DEFAULT NULL COLLATE BINARY, active BOOLEAN NOT NULL, role VARCHAR(255) NOT NULL COLLATE BINARY, role_to VARCHAR(255) NOT NULL COLLATE BINARY, role_cc VARCHAR(255) NOT NULL COLLATE BINARY, response_template CLOB DEFAULT NULL COLLATE BINARY, email_content_type VARCHAR(255) DEFAULT NULL COLLATE BINARY, circles_to CLOB DEFAULT NULL, orientation VARCHAR(20) DEFAULT NULL, size VARCHAR(20) DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_97601F831A445520 FOREIGN KEY (content_type_id) REFERENCES content_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE cache_asset_extractor (id INTEGER NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, hash VARCHAR(255) NOT NULL COLLATE BINARY, data CLOB DEFAULT NULL, PRIMARY KEY(id))');
