 ...
 */
final class Version20181030113315 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE search_field_option (id INTEGER NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL, field CLOB NOT NULL, orderKey INTEGER NOT NULL, icon CLOB DEFAULT NULL, contentTypes CLOB NOT NULL --(DC2Type:json_array)
        , operators CLOB NOT NULL --(DC2Type:json_array)
        , PRIMARY KEY(id))');
        ...
        $this->addSql('INSERT INTO revision (id, content_type_id, created, modified, auto_save_at, deleted, version, start_time, end_time, draft, lock_by, auto_save_by, lock_until, labelField, finalized_by, sha1, deleted_by, finalized_date, ouuid, raw_data, auto_save, circles) SELECT id, content_type_id, created, modified, auto_save_at, deleted, version, start_time, end_time, draft, lock_by, auto_save_by, lock_until, labelField, finalized_by, sha1, deleted_by, finalized_date, ouuid, raw_data, auto_save, circles FROM __temp__revision');
        ...
        $this->addSql('CREATE TABLE search (id INTEGER NOT NULL, content_type_id BIGINT DEFAULT NULL, username VARCHAR(100) NOT NULL COLLATE BINARY, contentTypes CLOB NOT NULL --(DC2Type:json_array)
