 ...
 */
final class Version20190325194056 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE uploaded_asset ADD COLUMN hash_algo VARCHAR(32) DEFAULT \'sha1\' NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE uploaded_asset (id INTEGER NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, status VARCHAR(64) DEFAULT NULL, sha1 VARCHAR(128) NOT NULL, name VARCHAR(1024) NOT NULL, type VARCHAR(1024) NOT NULL, username VARCHAR(255) NOT NULL, available BOOLEAN NOT NULL, size BIGINT NOT NULL, uploaded BIGINT NOT NULL, PRIMARY KEY(id))');
