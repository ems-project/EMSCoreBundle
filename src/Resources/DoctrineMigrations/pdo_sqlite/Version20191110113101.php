 ...
 */
final class Version20191110113101 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        , CONSTRAINT FK_6D6315CC1A445520 FOREIGN KEY (content_type_id) REFERENCES content_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE job (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, output CLOB DEFAULT NULL COLLATE BINARY, done BOOLEAN NOT NULL, started BOOLEAN NOT NULL, progress INTEGER NOT NULL, username VARCHAR(255) DEFAULT NULL COLLATE BINARY, service VARCHAR(255) DEFAULT NULL COLLATE BINARY, command VARCHAR(255) DEFAULT NULL COLLATE BINARY, status CLOB DEFAULT NULL COLLATE BINARY, arguments CLOB DEFAULT NULL --(DC2Type:json_array)
        )');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE audit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, date DATETIME NOT NULL, "action" VARCHAR(255) NOT NULL COLLATE BINARY, raw_data CLOB DEFAULT NULL COLLATE BINARY, username VARCHAR(255) NOT NULL COLLATE BINARY, environment VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('DROP INDEX IDX_8AF9B66CA76ED395');
        $this->addSql('DROP INDEX auth_tokens_value_unique');
        $this->addSql('CREATE TEMPORARY TABLE __temp__auth_tokens AS SELECT id, user_id, value, created, modified FROM auth_tokens');
        $this->addSql('DROP TABLE auth_tokens');
        ...
        $this->addSql('DROP TABLE job');
        $this->addSql('CREATE TABLE job (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, status CLOB DEFAULT NULL, output CLOB DEFAULT NULL, done BOOLEAN NOT NULL, started BOOLEAN NOT NULL, progress INTEGER NOT NULL, username VARCHAR(255) DEFAULT NULL, service VARCHAR(255) DEFAULT NULL, command VARCHAR(255) DEFAULT NULL, arguments CLOB DEFAULT \'NULL --(DC2Type:json_array)\' COLLATE BINARY --(DC2Type:json_array)
        )');
        ...
        , name VARCHAR(100) NOT NULL, default_search BOOLEAN DEFAULT \'0\' NOT NULL, sort_by VARCHAR(100) DEFAULT NULL, sort_order VARCHAR(100) DEFAULT NULL)');
