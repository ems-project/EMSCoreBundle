 ...
 */
final class Version20191218230957 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE job (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, output CLOB DEFAULT NULL COLLATE BINARY, done BOOLEAN NOT NULL, started BOOLEAN NOT NULL, progress INTEGER NOT NULL, username VARCHAR(255) DEFAULT NULL COLLATE BINARY, service VARCHAR(255) DEFAULT NULL COLLATE BINARY, status CLOB DEFAULT NULL COLLATE BINARY, arguments CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:json_array)
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE job');
        $this->addSql('CREATE TABLE job (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, status CLOB DEFAULT NULL, output CLOB DEFAULT NULL, done BOOLEAN NOT NULL, started BOOLEAN NOT NULL, progress INTEGER NOT NULL, arguments CLOB DEFAULT NULL --(DC2Type:json_array)
        , username VARCHAR(255) DEFAULT NULL, service VARCHAR(255) DEFAULT NULL, command VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
