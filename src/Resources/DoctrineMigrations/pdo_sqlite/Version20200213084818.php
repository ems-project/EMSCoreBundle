 ...
 */
final class Version20200213084818 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        , ouuid VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        ...
        , minimum_should_match INTEGER DEFAULT 1 NOT NULL)');
        ...
        $this->addSql('CREATE TABLE auth_tokens (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, value VARCHAR(255) NOT NULL COLLATE BINARY, created DATETIME NOT NULL, modified DATETIME NOT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX auth_tokens_value_unique');
        $this->addSql('CREATE TEMPORARY TABLE __temp__auth_tokens AS SELECT id, value, created, modified, user_id FROM auth_tokens');
        $this->addSql('DROP TABLE auth_tokens');
        $this->addSql('CREATE TABLE auth_tokens (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, value VARCHAR(255) NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, user_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO auth_tokens (id, value, created, modified, user_id) SELECT id, value, created, modified, user_id FROM __temp__auth_tokens');
        $this->addSql('DROP TABLE __temp__auth_tokens');
        $this->addSql('CREATE UNIQUE INDEX auth_tokens_value_unique ON auth_tokens (value)');
        $this->addSql('CREATE INDEX IDX_8AF9B66CA76ED395 ON auth_tokens (user_id)');
        $this->addSql('DROP INDEX UNIQ_41BCBAEC588AB49A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__content_type AS SELECT id, created, modified, name, pluralName, singularName, icon, description, indexTwig, extra, lockBy, lockUntil, circles_field, deleted, have_pipelines, ask_for_ouuid, dirty, color, labelField, color_field, parentField, userField, dateField, startDateField, endDateField, locationField, referer_field_name, category_field, ouuidField, imageField, videoField, email_field, asset_field, order_field, sort_by, sort_order, create_role, edit_role, view_role, publish_role, trash_role, orderKey, rootContentType, edit_twig_with_wysiwyg, web_content, auto_publish, active, default_value, field_types_id, environment_id FROM content_type');
        $this->addSql('DROP TABLE content_type');
        $this->addSql('CREATE TABLE content_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(100) NOT NULL, pluralName VARCHAR(100) NOT NULL, singularName VARCHAR(100) NOT NULL, icon VARCHAR(100) DEFAULT NULL, description CLOB DEFAULT NULL, indexTwig CLOB DEFAULT NULL, extra CLOB DEFAULT NULL, lockBy VARCHAR(100) DEFAULT NULL, lockUntil DATETIME DEFAULT NULL, circles_field VARCHAR(100) DEFAULT NULL, deleted BOOLEAN NOT NULL, have_pipelines BOOLEAN DEFAULT NULL, ask_for_ouuid BOOLEAN NOT NULL, dirty BOOLEAN NOT NULL, color VARCHAR(50) DEFAULT NULL, labelField VARCHAR(100) DEFAULT NULL, color_field VARCHAR(100) DEFAULT NULL, parentField VARCHAR(100) DEFAULT NULL, userField VARCHAR(100) DEFAULT NULL, dateField VARCHAR(100) DEFAULT NULL, startDateField VARCHAR(100) DEFAULT NULL, endDateField VARCHAR(100) DEFAULT NULL, locationField VARCHAR(100) DEFAULT NULL, referer_field_name VARCHAR(100) DEFAULT NULL, category_field VARCHAR(100) DEFAULT NULL, ouuidField VARCHAR(100) DEFAULT NULL, imageField VARCHAR(100) DEFAULT NULL, videoField VARCHAR(100) DEFAULT NULL, email_field VARCHAR(100) DEFAULT NULL, asset_field VARCHAR(100) DEFAULT NULL, order_field VARCHAR(100) DEFAULT NULL, sort_by VARCHAR(100) DEFAULT NULL, sort_order VARCHAR(4) DEFAULT \'asc\', create_role VARCHAR(100) DEFAULT NULL, edit_role VARCHAR(100) DEFAULT NULL, view_role VARCHAR(100) DEFAULT NULL, publish_role VARCHAR(100) DEFAULT NULL, trash_role VARCHAR(100) DEFAULT NULL, orderKey INTEGER NOT NULL, rootContentType BOOLEAN NOT NULL, edit_twig_with_wysiwyg BOOLEAN NOT NULL, web_content BOOLEAN DEFAULT \'1\' NOT NULL, auto_publish BOOLEAN DEFAULT \'0\' NOT NULL, active BOOLEAN NOT NULL, default_value CLOB DEFAULT NULL, field_types_id INTEGER DEFAULT NULL, environment_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO content_type (id, created, modified, name, pluralName, singularName, icon, description, indexTwig, extra, lockBy, lockUntil, circles_field, deleted, have_pipelines, ask_for_ouuid, dirty, color, labelField, color_field, parentField, userField, dateField, startDateField, endDateField, locationField, referer_field_name, category_field, ouuidField, imageField, videoField, email_field, asset_field, order_field, sort_by, sort_order, create_role, edit_role, view_role, publish_role, trash_role, orderKey, rootContentType, edit_twig_with_wysiwyg, web_content, auto_publish, active, default_value, field_types_id, environment_id) SELECT id, created, modified, name, pluralName, singularName, icon, description, indexTwig, extra, lockBy, lockUntil, circles_field, deleted, have_pipelines, ask_for_ouuid, dirty, color, labelField, color_field, parentField, userField, dateField, startDateField, endDateField, locationField, referer_field_name, category_field, ouuidField, imageField, videoField, email_field, asset_field, order_field, sort_by, sort_order, create_role, edit_role, view_role, publish_role, trash_role, orderKey, rootContentType, edit_twig_with_wysiwyg, web_content, auto_publish, active, default_value, field_types_id, environment_id FROM __temp__content_type');
        $this->addSql('DROP TABLE __temp__content_type');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_41BCBAEC588AB49A ON content_type (field_types_id)');
        ...
        $this->addSql('DROP INDEX UNIQ_9F123E931A445520');
        $this->addSql('CREATE TEMPORARY TABLE __temp__field_type AS SELECT id, created, modified, type, name, deleted, description, options, orderKey, content_type_id, parent_id FROM field_type');
        $this->addSql('DROP TABLE field_type');
        $this->addSql('CREATE TABLE field_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, type VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, deleted BOOLEAN NOT NULL, description CLOB DEFAULT NULL, options CLOB DEFAULT NULL --(DC2Type:json_array)
        , orderKey INTEGER NOT NULL, content_type_id BIGINT DEFAULT NULL, parent_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO field_type (id, created, modified, type, name, deleted, description, options, orderKey, content_type_id, parent_id) SELECT id, created, modified, type, name, deleted, description, options, orderKey, content_type_id, parent_id FROM __temp__field_type');
        $this->addSql('DROP TABLE __temp__field_type');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9F123E931A445520 ON field_type (content_type_id)');
        $this->addSql('CREATE INDEX IDX_9F123E93727ACA70 ON field_type (parent_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__notification AS SELECT id, created, modified, username, status, sent_timestamp, response_text, response_timestamp, response_by, emailed, response_emailed, template_id, revision_id, environment_id FROM notification');
        $this->addSql('DROP TABLE notification');
        $this->addSql('CREATE TABLE notification (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, username VARCHAR(100) NOT NULL, status VARCHAR(20) NOT NULL, sent_timestamp DATETIME NOT NULL, response_text CLOB DEFAULT NULL, response_timestamp DATETIME DEFAULT NULL, response_by VARCHAR(100) DEFAULT NULL, emailed DATETIME DEFAULT NULL, response_emailed DATETIME DEFAULT NULL, template_id INTEGER DEFAULT NULL, revision_id INTEGER DEFAULT NULL, environment_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO notification (id, created, modified, username, status, sent_timestamp, response_text, response_timestamp, response_by, emailed, response_emailed, template_id, revision_id, environment_id) SELECT id, created, modified, username, status, sent_timestamp, response_text, response_timestamp, response_by, emailed, response_emailed, template_id, revision_id, environment_id FROM __temp__notification');
        $this->addSql('DROP TABLE __temp__notification');
        ...
        $this->addSql('DROP INDEX tuple_index');
        $this->addSql('CREATE TEMPORARY TABLE __temp__revision AS SELECT id, created, modified, auto_save_at, deleted, version, ouuid, start_time, end_time, draft, finalized_by, finalized_date, deleted_by, lock_by, auto_save_by, lock_until, raw_data, auto_save, circles, labelField, sha1, content_type_id FROM revision');
        $this->addSql('DROP TABLE revision');
        $this->addSql('CREATE TABLE revision (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, auto_save_at DATETIME DEFAULT NULL, deleted BOOLEAN NOT NULL, version INTEGER DEFAULT 1 NOT NULL, start_time DATETIME NOT NULL, end_time DATETIME DEFAULT NULL, draft BOOLEAN NOT NULL, finalized_by VARCHAR(255) DEFAULT NULL, finalized_date DATETIME DEFAULT NULL, deleted_by VARCHAR(255) DEFAULT NULL, lock_by VARCHAR(255) DEFAULT NULL, auto_save_by VARCHAR(255) DEFAULT NULL, lock_until DATETIME DEFAULT NULL, raw_data CLOB DEFAULT NULL --(DC2Type:json_array)
        , auto_save CLOB DEFAULT NULL --(DC2Type:json_array)
        , circles CLOB DEFAULT NULL --(DC2Type:simple_array)
        , labelField CLOB DEFAULT NULL, sha1 VARCHAR(255) DEFAULT NULL, content_type_id BIGINT DEFAULT NULL, ouuid VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO revision (id, created, modified, auto_save_at, deleted, version, ouuid, start_time, end_time, draft, finalized_by, finalized_date, deleted_by, lock_by, auto_save_by, lock_until, raw_data, auto_save, circles, labelField, sha1, content_type_id) SELECT id, created, modified, auto_save_at, deleted, version, ouuid, start_time, end_time, draft, finalized_by, finalized_date, deleted_by, lock_by, auto_save_by, lock_until, raw_data, auto_save, circles, labelField, sha1, content_type_id FROM __temp__revision');
        $this->addSql('DROP TABLE __temp__revision');
        $this->addSql('CREATE UNIQUE INDEX tuple_index ON revision (end_time, ouuid)');
        $this->addSql('CREATE INDEX IDX_6D6315CC1A445520 ON revision (content_type_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__search_filter AS SELECT id, pattern, field, boolean_clause, operator, boost, search_id FROM search_filter');
        $this->addSql('DROP TABLE search_filter');
        $this->addSql('CREATE TABLE search_filter (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, pattern VARCHAR(200) DEFAULT NULL, field VARCHAR(100) DEFAULT NULL, boolean_clause VARCHAR(20) DEFAULT NULL, operator VARCHAR(50) NOT NULL, boost NUMERIC(10, 2) DEFAULT NULL, search_id BIGINT DEFAULT NULL)');
        $this->addSql('INSERT INTO search_filter (id, pattern, field, boolean_clause, operator, boost, search_id) SELECT id, pattern, field, boolean_clause, operator, boost, search_id FROM __temp__search_filter');
        $this->addSql('DROP TABLE __temp__search_filter');
        $this->addSql('CREATE INDEX IDX_A6263002650760A9 ON search_filter (search_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__single_type_index AS SELECT id, created, modified, name, content_type_id, environment_id FROM single_type_index');
        $this->addSql('DROP TABLE single_type_index');
        $this->addSql('CREATE TABLE single_type_index (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL, content_type_id BIGINT DEFAULT NULL, environment_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO single_type_index (id, created, modified, name, content_type_id, environment_id) SELECT id, created, modified, name, content_type_id, environment_id FROM __temp__single_type_index');
        $this->addSql('DROP TABLE __temp__single_type_index');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__template AS SELECT id, created, modified, name, icon, body, header, edit_with_wysiwyg, render_option, orderKey, accumulate_in_one_file, preview, mime_type, filename, extension, active, role, role_to, role_cc, circles_to, response_template, email_content_type, allow_origin, disposition, orientation, size, public, content_type_id FROM template');
        $this->addSql('DROP TABLE template');
        $this->addSql('CREATE TABLE template (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL, icon VARCHAR(255) DEFAULT NULL, body CLOB DEFAULT NULL, header CLOB DEFAULT NULL, edit_with_wysiwyg BOOLEAN NOT NULL, render_option VARCHAR(255) NOT NULL, orderKey INTEGER NOT NULL, accumulate_in_one_file BOOLEAN NOT NULL, preview BOOLEAN NOT NULL, mime_type VARCHAR(255) DEFAULT NULL, filename CLOB DEFAULT NULL, extension VARCHAR(255) DEFAULT NULL, active BOOLEAN NOT NULL, role VARCHAR(255) NOT NULL, role_to VARCHAR(255) NOT NULL, role_cc VARCHAR(255) NOT NULL, circles_to CLOB DEFAULT NULL --(DC2Type:json_array)
        , response_template CLOB DEFAULT NULL, email_content_type VARCHAR(255) DEFAULT NULL, allow_origin VARCHAR(255) DEFAULT NULL, disposition VARCHAR(20) DEFAULT NULL, orientation VARCHAR(20) DEFAULT NULL, size VARCHAR(20) DEFAULT NULL, public BOOLEAN DEFAULT \'0\' NOT NULL, content_type_id BIGINT DEFAULT NULL)');
        $this->addSql('INSERT INTO template (id, created, modified, name, icon, body, header, edit_with_wysiwyg, render_option, orderKey, accumulate_in_one_file, preview, mime_type, filename, extension, active, role, role_to, role_cc, circles_to, response_template, email_content_type, allow_origin, disposition, orientation, size, public, content_type_id) SELECT id, created, modified, name, icon, body, header, edit_with_wysiwyg, render_option, orderKey, accumulate_in_one_file, preview, mime_type, filename, extension, active, role, role_to, role_cc, circles_to, response_template, email_content_type, allow_origin, disposition, orientation, size, public, content_type_id FROM __temp__template');
        $this->addSql('DROP TABLE __temp__template');
        $this->addSql('CREATE INDEX IDX_97601F831A445520 ON template (content_type_id)');
        $this->addSql('DROP INDEX UNIQ_8D93D64992FC23A8');
        $this->addSql('DROP INDEX UNIQ_8D93D649A0D96FBF');
        $this->addSql('DROP INDEX UNIQ_8D93D649C05FB297');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, username_canonical, email, email_canonical, enabled, salt, password, last_login, confirmation_token, password_requested_at, roles, created, modified, circles, display_name, allowed_to_configure_wysiwyg, wysiwyg_options, layout_boxed, email_notification, sidebar_mini, sidebar_collapse, wysiwyg_profile_id FROM "user"');
        $this->addSql('DROP TABLE "user"');
        ...
        , display_name VARCHAR(255) DEFAULT NULL, allowed_to_configure_wysiwyg BOOLEAN DEFAULT NULL, wysiwyg_options CLOB DEFAULT NULL, layout_boxed BOOLEAN NOT NULL, email_notification BOOLEAN NOT NULL, sidebar_mini BOOLEAN NOT NULL, sidebar_collapse BOOLEAN NOT NULL, wysiwyg_profile_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO "user" (id, username, username_canonical, email, email_canonical, enabled, salt, password, last_login, confirmation_token, password_requested_at, roles, created, modified, circles, display_name, allowed_to_configure_wysiwyg, wysiwyg_options, layout_boxed, email_notification, sidebar_mini, sidebar_collapse, wysiwyg_profile_id) SELECT id, username, username_canonical, email, email_canonical, enabled, salt, password, last_login, confirmation_token, password_requested_at, roles, created, modified, circles, display_name, allowed_to_configure_wysiwyg, wysiwyg_options, layout_boxed, email_notification, sidebar_mini, sidebar_collapse, wysiwyg_profile_id FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D64992FC23A8 ON "user" (username_canonical)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649A0D96FBF ON "user" (email_canonical)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649C05FB297 ON "user" (confirmation_token)');
        $this->addSql('CREATE INDEX IDX_8D93D649A282F7EA ON "user" (wysiwyg_profile_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__view AS SELECT id, created, modified, name, type, icon, options, orderKey, public, content_type_id FROM "view"');
        $this->addSql('DROP TABLE "view"');
        $this->addSql('CREATE TABLE "view" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, icon VARCHAR(255) DEFAULT NULL, options CLOB DEFAULT NULL --(DC2Type:json_array)
        , orderKey INTEGER NOT NULL, public BOOLEAN DEFAULT \'0\' NOT NULL, content_type_id BIGINT DEFAULT NULL)');
        $this->addSql('INSERT INTO "view" (id, created, modified, name, type, icon, options, orderKey, public, content_type_id) SELECT id, created, modified, name, type, icon, options, orderKey, public, content_type_id FROM __temp__view');
        $this->addSql('DROP TABLE __temp__view');
