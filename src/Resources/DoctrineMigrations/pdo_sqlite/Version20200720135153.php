 ...
 */
final class Version20200720135153 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__form_submission AS SELECT id, created, modified, name, instance, locale, data FROM form_submission');
        ...
        , created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, instance VARCHAR(255) NOT NULL COLLATE BINARY, locale VARCHAR(2) NOT NULL COLLATE BINARY, data CLOB NOT NULL --(DC2Type:json_array)
        , process_try_counter INTEGER DEFAULT NULL, process_id VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO form_submission (id, created, modified, name, instance, locale, data) SELECT id, created, modified, name, instance, locale, data FROM __temp__form_submission');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL, instance VARCHAR(255) NOT NULL, locale VARCHAR(2) NOT NULL, data CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO form_submission (id, created, modified, name, instance, locale, data) SELECT id, created, modified, name, instance, locale, data FROM __temp__form_submission');
        $this->addSql('DROP TABLE __temp__form_submission');
        $this->addSql('DROP INDEX IDX_AEFF00A6422B0E0C');
