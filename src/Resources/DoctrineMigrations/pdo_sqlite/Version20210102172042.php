 ...
 */
final class Version20210102172042 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        , version_tag VARCHAR(255) DEFAULT NULL COLLATE BINARY, ouuid VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_6D6315CC1A445520 FOREIGN KEY (content_type_id) REFERENCES content_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO revision (id, content_type_id, created, modified, auto_save_at, deleted, version, start_time, end_time, draft, finalized_by, finalized_date, deleted_by, lock_by, auto_save_by, lock_until, raw_data, auto_save, circles, labelField, sha1, ouuid, version_uuid, version_tag) SELECT id, content_type_id, created, modified, auto_save_at, deleted, version, start_time, end_time, draft, finalized_by, finalized_date, deleted_by, lock_by, auto_save_by, lock_until, raw_data, auto_save, circles, labelField, sha1, ouuid, version_uuid, version_tag FROM __temp__revision');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__job AS SELECT id, created, modified, output, done, started, progress, username, status, command FROM job');
        $this->addSql('DROP TABLE job');
        $this->addSql('CREATE TABLE job (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, output CLOB DEFAULT NULL COLLATE BINARY, done BOOLEAN NOT NULL, started BOOLEAN NOT NULL, progress INTEGER NOT NULL, username VARCHAR(255) DEFAULT NULL COLLATE BINARY, status CLOB DEFAULT NULL COLLATE BINARY, command VARCHAR(2000) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO job (id, created, modified, output, done, started, progress, username, status, command) SELECT id, created, modified, output, done, started, progress, username, status, command FROM __temp__job');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__form_submission AS SELECT id, created, modified, name, instance, locale, process_id, process_try_counter, data, process_by, label, deadline_date, expire_date FROM form_submission');
        ...
        , process_by VARCHAR(255) DEFAULT NULL COLLATE BINARY, label VARCHAR(255) NOT NULL, deadline_date VARCHAR(255) NOT NULL, expire_date DATE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO form_submission (id, created, modified, name, instance, locale, process_id, process_try_counter, data, process_by, label, deadline_date, expire_date) SELECT id, created, modified, name, instance, locale, process_id, process_try_counter, data, process_by, label, deadline_date, expire_date FROM __temp__form_submission');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__asset_storage AS SELECT id, created, modified, contents, size, confirmed, hash FROM asset_storage');
        $this->addSql('DROP TABLE asset_storage');
        $this->addSql('CREATE TABLE asset_storage (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, contents BLOB NOT NULL, size BIGINT NOT NULL, confirmed BOOLEAN DEFAULT \'0\' NOT NULL, hash VARCHAR(1024) NOT NULL)');
        $this->addSql('INSERT INTO asset_storage (id, created, modified, contents, size, confirmed, hash) SELECT id, created, modified, contents, size, confirmed, hash FROM __temp__asset_storage');
        $this->addSql('DROP TABLE __temp__asset_storage');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__asset_storage AS SELECT id, created, modified, hash, contents, size, confirmed FROM asset_storage');
        $this->addSql('DROP TABLE asset_storage');
        $this->addSql('CREATE TABLE asset_storage (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, contents BLOB NOT NULL, size BIGINT NOT NULL, confirmed BOOLEAN DEFAULT \'0\' NOT NULL, hash VARCHAR(128) NOT NULL COLLATE BINARY, context VARCHAR(128) DEFAULT NULL COLLATE BINARY, last_update_date INTEGER NOT NULL)');
        $this->addSql('INSERT INTO asset_storage (id, created, modified, hash, contents, size, confirmed) SELECT id, created, modified, hash, contents, size, confirmed FROM __temp__asset_storage');
        $this->addSql('DROP TABLE __temp__asset_storage');
        ...
        $this->addSql('INSERT INTO content_type (id, field_types_id, environment_id, created, modified, name, pluralName, singularName, icon, description, indexTwig, extra, lockBy, lockUntil, circles_field, business_id_field, deleted, have_pipelines, ask_for_ouuid, dirty, color, labelField, color_field, userField, dateField, startDateField, endDateField, locationField, referer_field_name, category_field, ouuidField, imageField, videoField, email_field, asset_field, order_field, sort_by, sort_order, create_role, edit_role, view_role, publish_role, trash_role, orderKey, rootContentType, edit_twig_with_wysiwyg, web_content, auto_publish, active, default_value, translationField, localeField, searchLinkDisplayRole, createLinkDisplayRole, version_tags, version_date_from_field, version_date_to_field) SELECT id, field_types_id, environment_id, created, modified, name, pluralName, singularName, icon, description, indexTwig, extra, lockBy, lockUntil, circles_field, business_id_field, deleted, have_pipelines, ask_for_ouuid, dirty, color, labelField, color_field, userField, dateField, startDateField, endDateField, locationField, referer_field_name, category_field, ouuidField, imageField, videoField, email_field, asset_field, order_field, sort_by, sort_order, create_role, edit_role, view_role, publish_role, trash_role, orderKey, rootContentType, edit_twig_with_wysiwyg, web_content, auto_publish, active, default_value, translationField, localeField, searchLinkDisplayRole, createLinkDisplayRole, version_tags, version_date_from_field, version_date_to_field FROM __temp__content_type');
        $this->addSql('DROP TABLE __temp__content_type');
        $this->addSql('DROP INDEX IDX_895F7B701DFA7C8F');
        $this->addSql('DROP INDEX IDX_895F7B70903E3A94');
        $this->addSql('CREATE TEMPORARY TABLE __temp__environment_revision AS SELECT revision_id, environment_id FROM environment_revision');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9F123E931A445520 ON field_type (content_type_id)');
        $this->addSql('CREATE INDEX IDX_9F123E93727ACA70 ON field_type (parent_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__form_submission AS SELECT id, created, modified, name, instance, locale, data, expire_date, label, deadline_date, process_try_counter, process_id, process_by FROM form_submission');
        $this->addSql('DROP TABLE form_submission');
        ...
        , process_try_counter INTEGER DEFAULT 0 NOT NULL, process_id VARCHAR(255) DEFAULT NULL, process_by VARCHAR(255) DEFAULT NULL, expire_date DATE DEFAULT NULL, label VARCHAR(255) DEFAULT NULL COLLATE BINARY, deadline_date VARCHAR(255) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO form_submission (id, created, modified, name, instance, locale, data, expire_date, label, deadline_date, process_try_counter, process_id, process_by) SELECT id, created, modified, name, instance, locale, data, expire_date, label, deadline_date, process_try_counter, process_id, process_by FROM __temp__form_submission');
        $this->addSql('DROP TABLE __temp__form_submission');
        $this->addSql('DROP INDEX IDX_AEFF00A6422B0E0C');
        $this->addSql('CREATE TEMPORARY TABLE __temp__form_submission_file AS SELECT id, form_submission_id, created, modified, file, filename, form_field, mime_type, size FROM form_submission_file');
        $this->addSql('DROP TABLE form_submission_file');
        ...
        $this->addSql('DROP TABLE __temp__form_submission_file');
        $this->addSql('CREATE INDEX IDX_AEFF00A6422B0E0C ON form_submission_file (form_submission_id)');
        $this->addSql('ALTER TABLE job ADD COLUMN service VARCHAR(255) DEFAULT NULL COLLATE BINARY');
        $this->addSql('ALTER TABLE job ADD COLUMN arguments CLOB DEFAULT NULL COLLATE BINARY');
        $this->addSql('DROP INDEX IDX_BF5476CA5DA0FB8');
        $this->addSql('DROP INDEX IDX_BF5476CA1DFA7C8F');
        $this->addSql('DROP INDEX IDX_BF5476CA903E3A94');
        $this->addSql('CREATE TEMPORARY TABLE __temp__notification AS SELECT id, template_id, revision_id, environment_id, created, modified, username, status, sent_timestamp, response_text, response_timestamp, response_by, emailed, response_emailed FROM notification');
