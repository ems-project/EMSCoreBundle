 ...
 */
final class Version20210210211236 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wysiwyg_styles_set ADD COLUMN format_tags VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE wysiwyg_styles_set ADD COLUMN content_css VARCHAR(2048) DEFAULT NULL');
        $this->addSql('ALTER TABLE wysiwyg_styles_set ADD COLUMN assets CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE wysiwyg_styles_set ADD COLUMN save_dir VARCHAR(2048) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE __temp__view');
        $this->addSql('CREATE INDEX IDX_FEFDAB8E1A445520 ON "view" (content_type_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__wysiwyg_styles_set AS SELECT id, created, modified, name, config, orderKey FROM wysiwyg_styles_set');
        $this->addSql('DROP TABLE wysiwyg_styles_set');
        $this->addSql('CREATE TABLE wysiwyg_styles_set (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL, config CLOB DEFAULT NULL, orderKey INTEGER NOT NULL)');
        $this->addSql('INSERT INTO wysiwyg_styles_set (id, created, modified, name, config, orderKey) SELECT id, created, modified, name, config, orderKey FROM __temp__wysiwyg_styles_set');
