 ...
 */
final class Version20210412104236 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__wysiwyg_styles_set AS SELECT id, created, modified, name, config, orderKey, format_tags, content_css, assets, save_dir FROM wysiwyg_styles_set');
        $this->addSql('DROP TABLE wysiwyg_styles_set');
        $this->addSql('CREATE TABLE wysiwyg_styles_set (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, config CLOB DEFAULT NULL COLLATE BINARY, orderKey INTEGER NOT NULL, format_tags VARCHAR(255) DEFAULT NULL COLLATE BINARY, content_css VARCHAR(2048) DEFAULT NULL COLLATE BINARY, save_dir VARCHAR(2048) DEFAULT NULL COLLATE BINARY, assets CLOB DEFAULT NULL --(DC2Type:json)
        , table_default_css VARCHAR(255) DEFAULT \'table table-bordered\' NOT NULL)');
        $this->addSql('INSERT INTO wysiwyg_styles_set (id, created, modified, name, config, orderKey, format_tags, content_css, assets, save_dir) SELECT id, created, modified, name, config, orderKey, format_tags, content_css, assets, save_dir FROM __temp__wysiwyg_styles_set');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__wysiwyg_styles_set AS SELECT id, created, modified, name, config, orderKey, format_tags, content_css, assets, save_dir FROM wysiwyg_styles_set');
        $this->addSql('DROP TABLE wysiwyg_styles_set');
        $this->addSql('CREATE TABLE wysiwyg_styles_set (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL, config CLOB DEFAULT NULL, orderKey INTEGER NOT NULL, format_tags VARCHAR(255) DEFAULT NULL, content_css VARCHAR(2048) DEFAULT NULL, save_dir VARCHAR(2048) DEFAULT NULL, assets CLOB DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO wysiwyg_styles_set (id, created, modified, name, config, orderKey, format_tags, content_css, assets, save_dir) SELECT id, created, modified, name, config, orderKey, format_tags, content_css, assets, save_dir FROM __temp__wysiwyg_styles_set');
        $this->addSql('DROP TABLE __temp__wysiwyg_styles_set');
    }
}
