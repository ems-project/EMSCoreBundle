 ...
 */
final class Version20210816123017 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        , title VARCHAR(255) NOT NULL, status VARCHAR(25) NOT NULL, deadline DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , assignee CLOB NOT NULL, description CLOB NOT NULL, logs CLOB NOT NULL --(DC2Type:json)
        , PRIMARY KEY(id))');
        $this->addSql('CREATE TEMPORARY TABLE __temp__channel AS SELECT id, created, modified, name, public, label, options, order_key, alias FROM channel');
        $this->addSql('DROP TABLE channel');
        $this->addSql('CREATE TABLE channel (id CHAR(36) NOT NULL COLLATE BINARY --(DC2Type:uuid)
        , created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, public BOOLEAN DEFAULT \'0\' NOT NULL, label VARCHAR(255) NOT NULL COLLATE BINARY, options CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:json)
        , order_key INTEGER NOT NULL, alias VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO channel (id, created, modified, name, public, label, options, order_key, alias) SELECT id, created, modified, name, public, label, options, order_key, alias FROM __temp__channel');
        $this->addSql('DROP TABLE __temp__channel');
        $this->addSql('CREATE TEMPORARY TABLE __temp__content_type AS SELECT id, field_types_id, environment_id, created, modified, name, pluralName, singularName, icon, description, indexTwig, extra, lockBy, lockUntil, circles_field, deleted, have_pipelines, ask_for_ouuid, dirty, color, labelField, color_field, userField, dateField, startDateField, endDateField, locationField, referer_field_name, category_field, ouuidField, imageField, videoField, email_field, asset_field, order_field, sort_by, create_role, edit_role, view_role, orderKey, rootContentType, edit_twig_with_wysiwyg, active, publish_role, trash_role, sort_order, web_content, default_value, auto_publish, business_id_field, translationField, localeField, searchLinkDisplayRole, createLinkDisplayRole, version_date_from_field, version_tags, version_date_to_field, delete_role FROM content_type');
        ...
        , version_tag VARCHAR(255) DEFAULT NULL COLLATE BINARY, archived BOOLEAN DEFAULT \'0\' NOT NULL, archived_by VARCHAR(255) DEFAULT NULL COLLATE BINARY, ouuid VARCHAR(255) DEFAULT NULL COLLATE BINARY, task_planned_ids CLOB DEFAULT NULL --(DC2Type:json)
        , task_approved_ids CLOB DEFAULT NULL --(DC2Type:json)
        , owner CLOB DEFAULT NULL, CONSTRAINT FK_6D6315CC1A445520 FOREIGN KEY (content_type_id) REFERENCES content_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6D6315CCE99931F3 FOREIGN KEY (task_current_id) REFERENCES task (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO revision (id, content_type_id, created, modified, auto_save_at, deleted, version, start_time, end_time, draft, finalized_by, finalized_date, deleted_by, lock_by, auto_save_by, lock_until, raw_data, auto_save, circles, labelField, sha1, version_uuid, version_tag, ouuid, archived, archived_by) SELECT id, content_type_id, created, modified, auto_save_at, deleted, version, start_time, end_time, draft, finalized_by, finalized_date, deleted_by, lock_by, auto_save_by, lock_until, raw_data, auto_save, circles, labelField, sha1, version_uuid, version_tag, ouuid, archived, archived_by FROM __temp__revision');
        ...
        $this->addSql('ALTER TABLE uploaded_asset ADD COLUMN hidden BOOLEAN DEFAULT \'0\' NOT NULL');
        $this->addSql('ALTER TABLE uploaded_asset ADD COLUMN head_last DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE uploaded_asset ADD COLUMN head_in CLOB DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_8AF9B66CA76ED395 ON auth_tokens (user_id)');
        $this->addSql('CREATE UNIQUE INDEX auth_tokens_value_unique ON auth_tokens (value)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__channel AS SELECT id, created, modified, name, alias, public, label, options, order_key FROM channel');
        $this->addSql('DROP TABLE channel');
        ...
        , order_key INTEGER NOT NULL, alias VARCHAR(255) DEFAULT \'alias\' NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO channel (id, created, modified, name, alias, public, label, options, order_key) SELECT id, created, modified, name, alias, public, label, options, order_key FROM __temp__channel');
        $this->addSql('DROP TABLE __temp__channel');
        $this->addSql('DROP INDEX UNIQ_41BCBAEC588AB49A');
        $this->addSql('DROP INDEX IDX_41BCBAEC903E3A94');
        $this->addSql('CREATE TEMPORARY TABLE __temp__content_type AS SELECT id, field_types_id, environment_id, created, modified, name, pluralName, singularName, icon, description, indexTwig, extra, lockBy, lockUntil, circles_field, business_id_field, deleted, have_pipelines, ask_for_ouuid, dirty, color, labelField, color_field, userField, dateField, startDateField, endDateField, locationField, referer_field_name, category_field, ouuidField, imageField, videoField, email_field, asset_field, order_field, sort_by, sort_order, create_role, edit_role, view_role, publish_role, delete_role, trash_role, orderKey, rootContentType, edit_twig_with_wysiwyg, web_content, auto_publish, active, default_value, translationField, localeField, searchLinkDisplayRole, createLinkDisplayRole, version_tags, version_date_from_field, version_date_to_field FROM content_type');
        $this->addSql('DROP TABLE content_type');
        ...
        $this->addSql('INSERT INTO content_type (id, field_types_id, environment_id, created, modified, name, pluralName, singularName, icon, description, indexTwig, extra, lockBy, lockUntil, circles_field, business_id_field, deleted, have_pipelines, ask_for_ouuid, dirty, color, labelField, color_field, userField, dateField, startDateField, endDateField, locationField, referer_field_name, category_field, ouuidField, imageField, videoField, email_field, asset_field, order_field, sort_by, sort_order, create_role, edit_role, view_role, publish_role, delete_role, trash_role, orderKey, rootContentType, edit_twig_with_wysiwyg, web_content, auto_publish, active, default_value, translationField, localeField, searchLinkDisplayRole, createLinkDisplayRole, version_tags, version_date_from_field, version_date_to_field) SELECT id, field_types_id, environment_id, created, modified, name, pluralName, singularName, icon, description, indexTwig, extra, lockBy, lockUntil, circles_field, business_id_field, deleted, have_pipelines, ask_for_ouuid, dirty, color, labelField, color_field, userField, dateField, startDateField, endDateField, locationField, referer_field_name, category_field, ouuidField, imageField, videoField, email_field, asset_field, order_field, sort_by, sort_order, create_role, edit_role, view_role, publish_role, delete_role, trash_role, orderKey, rootContentType, edit_twig_with_wysiwyg, web_content, auto_publish, active, default_value, translationField, localeField, searchLinkDisplayRole, createLinkDisplayRole, version_tags, version_date_from_field, version_date_to_field FROM __temp__content_type');
        $this->addSql('DROP TABLE __temp__content_type');
        $this->addSql('DROP INDEX IDX_1DF055936B6C19');
        $this->addSql('DROP INDEX IDX_1DF055903E3A94');
        $this->addSql('CREATE TEMPORARY TABLE __temp__environment_query_search AS SELECT query_search_id, environment_id FROM environment_query_search');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__revision AS SELECT id, content_type_id, created, modified, auto_save_at, archived, deleted, version, ouuid, start_time, end_time, draft, finalized_by, finalized_date, archived_by, deleted_by, lock_by, auto_save_by, lock_until, raw_data, auto_save, circles, labelField, sha1, version_uuid, version_tag FROM revision');
        $this->addSql('DROP TABLE revision');
        ...
        $this->addSql('INSERT INTO revision (id, content_type_id, created, modified, auto_save_at, archived, deleted, version, ouuid, start_time, end_time, draft, finalized_by, finalized_date, archived_by, deleted_by, lock_by, auto_save_by, lock_until, raw_data, auto_save, circles, labelField, sha1, version_uuid, version_tag) SELECT id, content_type_id, created, modified, auto_save_at, archived, deleted, version, ouuid, start_time, end_time, draft, finalized_by, finalized_date, archived_by, deleted_by, lock_by, auto_save_by, lock_until, raw_data, auto_save, circles, labelField, sha1, version_uuid, version_tag FROM __temp__revision');
        $this->addSql('DROP TABLE __temp__revision');
        $this->addSql('DROP INDEX UNIQ_B4F0DBA71A445520');
        ...
        $this->addSql('DROP TABLE __temp__template');
        $this->addSql('CREATE INDEX IDX_97601F831A445520 ON template (content_type_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__uploaded_asset AS SELECT id, created, modified, status, sha1, name, type, username, available, size, uploaded, hash_algo FROM uploaded_asset');
        ...
        $this->addSql('INSERT INTO uploaded_asset (id, created, modified, status, sha1, name, type, username, available, size, uploaded, hash_algo) SELECT id, created, modified, status, sha1, name, type, username, available, size, uploaded, hash_algo FROM __temp__uploaded_asset');
