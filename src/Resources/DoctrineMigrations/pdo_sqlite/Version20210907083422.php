 ...
 */
final class Version20210907083422 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        , orderKey INTEGER NOT NULL, public BOOLEAN DEFAULT \'0\' NOT NULL, CONSTRAINT FK_FEFDAB8E1A445520 FOREIGN KEY (content_type_id) REFERENCES content_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
