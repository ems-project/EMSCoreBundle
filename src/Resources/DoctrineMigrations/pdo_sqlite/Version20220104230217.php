...
final class Version20220104230217 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE template (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, content_type_id BIGINT DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, icon VARCHAR(255) DEFAULT NULL COLLATE BINARY, body CLOB DEFAULT NULL COLLATE BINARY, header CLOB DEFAULT NULL COLLATE BINARY, edit_with_wysiwyg BOOLEAN NOT NULL, render_option VARCHAR(255) NOT NULL COLLATE BINARY, orderKey INTEGER NOT NULL, accumulate_in_one_file BOOLEAN NOT NULL, preview BOOLEAN NOT NULL, mime_type VARCHAR(255) DEFAULT NULL COLLATE BINARY, filename CLOB DEFAULT NULL COLLATE BINARY, extension VARCHAR(255) DEFAULT NULL COLLATE BINARY, active BOOLEAN NOT NULL, role VARCHAR(255) NOT NULL COLLATE BINARY, role_to VARCHAR(255) NOT NULL COLLATE BINARY, role_cc VARCHAR(255) NOT NULL COLLATE BINARY, circles_to CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:json_array)
        , response_template CLOB DEFAULT NULL COLLATE BINARY, email_content_type VARCHAR(255) DEFAULT NULL COLLATE BINARY, allow_origin VARCHAR(255) DEFAULT NULL COLLATE BINARY, disposition VARCHAR(20) DEFAULT NULL COLLATE BINARY, orientation VARCHAR(20) DEFAULT NULL COLLATE BINARY, size VARCHAR(20) DEFAULT NULL COLLATE BINARY, public BOOLEAN DEFAULT \'0\' NOT NULL, CONSTRAINT FK_97601F831A445520 FOREIGN KEY (content_type_id) REFERENCES content_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE search (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, content_type_id BIGINT DEFAULT NULL, username VARCHAR(100) NOT NULL COLLATE BINARY, environments CLOB NOT NULL COLLATE BINARY --(DC2Type:json_array)
        , contentTypes CLOB NOT NULL COLLATE BINARY --(DC2Type:json_array)
        , name VARCHAR(100) NOT NULL COLLATE BINARY, default_search BOOLEAN DEFAULT \'0\' NOT NULL, sort_by VARCHAR(100) DEFAULT NULL COLLATE BINARY, sort_order VARCHAR(100) DEFAULT NULL COLLATE BINARY, minimum_should_match INTEGER DEFAULT 1 NOT NULL, CONSTRAINT FK_B4F0DBA71A445520 FOREIGN KEY (content_type_id) REFERENCES content_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        , owner CLOB DEFAULT NULL COLLATE BINARY, draft_save_date DATETIME DEFAULT NULL, ouuid VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_6D6315CC1A445520 FOREIGN KEY (content_type_id) REFERENCES content_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6D6315CCE99931F3 FOREIGN KEY (task_current_id) REFERENCES task (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO revision (id, content_type_id, task_current_id, created, modified, auto_save_at, archived, deleted, version, start_time, end_time, draft, finalized_by, finalized_date, archived_by, deleted_by, lock_by, auto_save_by, lock_until, raw_data, auto_save, circles, labelField, sha1, version_uuid, version_tag, task_planned_ids, task_approved_ids, owner, ouuid, draft_save_date) SELECT id, content_type_id, task_current_id, created, modified, auto_save_at, archived, deleted, version, start_time, end_time, draft, finalized_by, finalized_date, archived_by, deleted_by, lock_by, auto_save_by, lock_until, raw_data, auto_save, circles, labelField, sha1, version_uuid, version_tag, task_planned_ids, task_approved_ids, owner, ouuid, draft_save_date FROM __temp__revision');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__view AS SELECT id, content_type_id, created, modified, name, type, icon, options, public, order_key, role FROM "view"');
        ...
        , public BOOLEAN DEFAULT \'0\' NOT NULL, order_key INTEGER NOT NULL, role VARCHAR(100) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_FEFDAB8E1A445520 FOREIGN KEY (content_type_id) REFERENCES content_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO "view" (id, content_type_id, created, modified, name, type, icon, options, public, order_key, role) SELECT id, content_type_id, created, modified, name, type, icon, options, public, order_key, role FROM __temp__view');
        ...
        $this->addSql('DROP INDEX IDX_3663CEAD1A445520');
        $this->addSql('DROP INDEX IDX_3663CEADFBFE9068');
        $this->addSql('DROP INDEX IDX_3663CEAD1DFA7C8F');
        $this->addSql('DROP INDEX IDX_3663CEADB12A727D');
        $this->addSql('CREATE TEMPORARY TABLE __temp__release_revision AS SELECT id, release_id, revision_id, revision_before_publish_id, content_type_id, revision_ouuid FROM release_revision');
        $this->addSql('DROP TABLE release_revision');
        $this->addSql('CREATE TABLE release_revision (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, release_id INTEGER DEFAULT NULL, revision_id INTEGER DEFAULT NULL, revision_before_publish_id INTEGER DEFAULT NULL, content_type_id BIGINT DEFAULT NULL, revision_ouuid VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_3663CEADB12A727D FOREIGN KEY (release_id) REFERENCES release_entity (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3663CEAD1DFA7C8F FOREIGN KEY (revision_id) REFERENCES revision (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3663CEADFBFE9068 FOREIGN KEY (revision_before_publish_id) REFERENCES revision (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3663CEAD1A445520 FOREIGN KEY (content_type_id) REFERENCES content_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO release_revision (id, release_id, revision_id, revision_before_publish_id, content_type_id, revision_ouuid) SELECT id, release_id, revision_id, revision_before_publish_id, content_type_id, revision_ouuid FROM __temp__release_revision');
        $this->addSql('DROP TABLE __temp__release_revision');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__release_revision AS SELECT id, release_id, revision_id, revision_before_publish_id, content_type_id, revision_ouuid FROM release_revision');
        $this->addSql('DROP TABLE release_revision');
        $this->addSql('CREATE TABLE release_revision (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, release_id INTEGER DEFAULT NULL, revision_id INTEGER DEFAULT NULL, revision_before_publish_id INTEGER DEFAULT NULL, content_type_id BIGINT DEFAULT NULL, revision_ouuid VARCHAR(255) NOT NULL, CONSTRAINT FK_3663CEADB12A727D FOREIGN KEY (release_id) REFERENCES release_entity (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO release_revision (id, release_id, revision_id, revision_before_publish_id, content_type_id, revision_ouuid) SELECT id, release_id, revision_id, revision_before_publish_id, content_type_id, revision_ouuid FROM __temp__release_revision');
        $this->addSql('DROP TABLE __temp__release_revision');
        $this->addSql('CREATE INDEX IDX_3663CEADB12A727D ON release_revision (release_id)');
        $this->addSql('CREATE INDEX IDX_3663CEAD1DFA7C8F ON release_revision (revision_id)');
        ...
        , version_tag VARCHAR(255) DEFAULT NULL, draft_save_date DATETIME DEFAULT NULL, task_planned_ids CLOB DEFAULT NULL --(DC2Type:json)
        , task_approved_ids CLOB DEFAULT NULL --(DC2Type:json)
        , owner CLOB DEFAULT NULL, ouuid VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO revision (id, content_type_id, task_current_id, created, modified, auto_save_at, archived, deleted, version, ouuid, start_time, end_time, draft, finalized_by, finalized_date, archived_by, deleted_by, lock_by, auto_save_by, lock_until, raw_data, auto_save, circles, labelField, sha1, version_uuid, version_tag, draft_save_date, task_planned_ids, task_approved_ids, owner) SELECT id, content_type_id, task_current_id, created, modified, auto_save_at, archived, deleted, version, ouuid, start_time, end_time, draft, finalized_by, finalized_date, archived_by, deleted_by, lock_by, auto_save_by, lock_until, raw_data, auto_save, circles, labelField, sha1, version_uuid, version_tag, draft_save_date, task_planned_ids, task_approved_ids, owner FROM __temp__revision');
        $this->addSql('DROP TABLE __temp__revision');
        $this->addSql('CREATE INDEX IDX_6D6315CC1A445520 ON revision (content_type_id)');
        $this->addSql('CREATE INDEX IDX_6D6315CCE99931F3 ON revision (task_current_id)');
        $this->addSql('CREATE UNIQUE INDEX tuple_index ON revision (end_time, ouuid)');
        ...
        $this->addSql('CREATE INDEX IDX_8D93D649A282F7EA ON "user" (wysiwyg_profile_id)');
        $this->addSql('DROP INDEX IDX_FEFDAB8E1A445520');
        $this->addSql('CREATE TEMPORARY TABLE __temp__view AS SELECT id, content_type_id, created, modified, name, type, icon, options, order_key, public, role FROM "view"');
        $this->addSql('DROP TABLE "view"');
        ...
        , order_key INTEGER NOT NULL, public BOOLEAN DEFAULT \'0\' NOT NULL, role VARCHAR(100) DEFAULT NULL)');
        $this->addSql('INSERT INTO "view" (id, content_type_id, created, modified, name, type, icon, options, order_key, public, role) SELECT id, content_type_id, created, modified, name, type, icon, options, order_key, public, role FROM __temp__view');
        $this->addSql('DROP TABLE __temp__view');
        $this->addSql('CREATE INDEX IDX_FEFDAB8E1A445520 ON "view" (content_type_id)');
    }
}
